...
# Exercise-2 TODOs:
    ...
    vox = sts_filter.make_voxel_grid_filter()
    LEAF_SIZE = 0.01
    ...
    extracted_inliers = cloud_filtered.extract(inliers, negative=False) # Table detail
    extracted_outliers = cloud_filtered.extract(inliers, negative=True) # Objects detail
